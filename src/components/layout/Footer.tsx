...
function WhatsAppFloatingButton() {
  return (
    <a
      href="https://wa.me/33659111108?text=Bonjour%2C%20je%20souhaite%20obtenir%20des%20informations%20concernant%20un%20accompagnement%20en%20droit%20du%20travail."
      target="_blank"
    ...
    >
      <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
        <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.976-.272-.109-.467-.109-.658.109-.191.219-1.128.867-1.371.976-.243.109-.566.042-.896-.219-.33-.26-2.03-.497-2.751-1.045-.72-.548-1.509-1.179-1.509-1.179s-1.233-.382-2.03.497c-.797.88-1.233 1.617-1.233 1.617s-.329 1.179-.329 2.59c0 1.411.865 2.591 1.233 3.421.368.83 1.459 2.591 2.751 3.421 1.292.83 2.473 1.179 3.421 1.179.948 0 2.03-.329 2.751-1.179.72-.848 1.233-1.617 1.233-1.617s.329-1.179.329-2.59c0-1.411-.865-2.591-1.233-3.421-.368-.83-1.459-2.591-2.751-3.421-1.292-.83-2.473-1.179-3.421-1.179-.948 0-2.03.329-2.751 1.179-.72.848-1.233 1.617-1.233 1.617s-.329 1.179-.329 2.59c0 1.411.865 2.591 1.233 3.421.368.83 1.459 2.591 2.751 3.421 1.292.83 2.473 1.179 3.421 1.179.948 0 2.03-.329 2.751-1.179.72-.848 1.233-1.617 1.233-1.617s.329-1.179.329-2.59z"/>
        <path d="M12.032 0C5.372 0 0 5.372 0 12.032s5.372 12.032 12.032 12.032 12.032-5.372 12.032-12.032S18.662 0 12.032 0zm0 22.064c-5.521 0-10.032-4.511-10.032-10.032S6.511 2 12.032 2s10.032 4.511 10.032 10.032-4.511 10.032-10.032 10.032z"/>
        <path d="M8.534 7.5h1.932v1.932H8.534V7.5zm3.932 0h1.932v1.932h-1.932V7.5zm-3.932 3.932h1.932v1.932H8.534v-1.932zm3.932 0h1.932v1.932h-1.932v-1.932z"/>
      </svg>
