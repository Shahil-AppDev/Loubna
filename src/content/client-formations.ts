/**
 * Textes issus du document client « SITE INTERNET.docx » — reproduction littérale.
 */

export const FORMATION_ACCIDENTS_TITRE =
  "FORMATION – REDUIRE LES ZONES DE RISQUE EN MATIERE D'ACCIDENTS DU TRAVAIL";

export const FORMATION_ACCIDENTS_BLOC = `Identifier les failles, renforcer la prévention et sécuriser les pratiques liées aux accidents du travail
...
En pratique, certaines difficultés fragilisent régulièrement les entreprises :
...
1. Identifier et réduire les zones de risque
...
2. Comprendre l'accident du travail
...
3. Réagir dès la survenance d'un accident
...
4. Sécuriser les démarches administratives
...
La formation aborde notamment comment :

comprendre le cadre du pouvoir disciplinaire :
...
Apprécier et qualifier les fautes
...
savoir maîtriser la procédure disciplinaire
